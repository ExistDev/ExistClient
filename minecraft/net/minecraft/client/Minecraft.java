...
import me.existdev.exist.gui.GuiStartMenu;
import me.existdev.exist.gui.IngameGUI;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
	...
	public Minecraft(GameConfiguration p_i45547_1_) {
		...
		this.mcDefaultResourcePack = new DefaultResourcePack(
				(new ResourceIndex(p_i45547_1_.field_178744_c.field_178759_c,
						p_i45547_1_.field_178744_c.field_178757_d)).func_152782_a());
		this.proxy = p_i45547_1_.field_178745_a.field_178751_c == null ? Proxy.NO_PROXY
				: p_i45547_1_.field_178745_a.field_178751_c;
		this.sessionService = (new YggdrasilAuthenticationService(p_i45547_1_.field_178745_a.field_178751_c,
		...
		this.displayWidth = p_i45547_1_.field_178743_b.field_178764_a > 0 ? p_i45547_1_.field_178743_b.field_178764_a
				: 1;
		this.displayHeight = p_i45547_1_.field_178743_b.field_178762_b > 0 ? p_i45547_1_.field_178743_b.field_178762_b
				: 1;
	...
	private void startGame() throws LWJGLException {
		...
		this.getMinecraft().displayGuiScreen(new GuiMainMenu());

		this.renderGlobal.func_174966_b();
		main = new Exist();
		Exist.fileManager.loadFiles();
		Exist.fileManager.loadLastAlt();
		Exist.fileManager.loadAlts();
	}
	...
	private void func_180510_a(TextureManager p_180510_1_) {
		...
		GlStateManager.matrixMode(5889);
		GlStateManager.loadIdentity();
		GlStateManager.ortho(0.0D, (double) var2.getScaledWidth(), (double) var2.getScaledHeight(), 0.0D, 1000.0D,
				3000.0D);
		GlStateManager.matrixMode(5888);
		GlStateManager.loadIdentity();
		...
		short var8 = 256;
		short var9 = 256;
		this.scaledTessellator((var2.getScaledWidth() - var8) / 2, (var2.getScaledHeight() - var9) / 2, 0, 0, var8,
				var9);
		GlStateManager.disableLighting();
		GlStateManager.disableFog();
	...
	public void scaledTessellator(int width, int height, int width2, int height2, int stdTextureWidth,
		...
		var9.addVertexWithUV((double) (width + 0), (double) (height + stdTextureHeight), 0.0D,
				(double) ((float) (width2 + 0) * var7), (double) ((float) (height2 + stdTextureHeight) * var8));
		var9.addVertexWithUV((double) (width + stdTextureWidth), (double) (height + stdTextureHeight), 0.0D,
				(double) ((float) (width2 + stdTextureWidth) * var7),
	...
	private void runGameLoop() throws IOException {
		...
		while (getSystemTime() >= this.debugUpdateTime + 1000L) {
			...
			this.debug = String.format("%d fps (%d chunk update%s) T: %s%s%s%s%s", new Object[] {
					Integer.valueOf(debugFPS), Integer.valueOf(RenderChunk.field_178592_a),
					RenderChunk.field_178592_a != 1 ? "s" : "",
					(float) this.gameSettings.limitFramerate == GameSettings.Options.FRAMERATE_LIMIT.getValueMax()
							? "inf" : Integer.valueOf(this.gameSettings.limitFramerate),
					this.gameSettings.enableVsync ? " vsync" : "", this.gameSettings.fancyGraphics ? "" : " fast",
					this.gameSettings.clouds ? " clouds" : "", OpenGlHelper.func_176075_f() ? " vbo" : "" });
		...
		if (var2 != null && !var2.isEmpty()) {
			...
			if (keyCount == 0) {
				...
				if (keyCount < var2.size()
					...
					this.debugProfilerName = this.debugProfilerName
							+ ((Profiler.Result) var2.get(keyCount)).field_76331_c;
				}
			}
		}
	}
	...
	private void displayDebugInfo(long elapsedTicksTime) {
		if (this.mcProfiler.profilingEnabled) {
			...
			var6.addVertex((double) ((float) var8 - (float) var7 * 1.1F),
					(double) ((float) var9 - (float) var7 * 0.6F - 16.0F), 0.0D);
			...
			for (int var12 = 0; var12 < var3.size(); ++var12) {
				...
				for (var15 = var14; var15 >= 0; --var15) {
					var16 = (float) ((var10 + var13.field_76332_a * (double) var15 / (double) var14) * Math.PI * 2.0D
							/ 100.0D);
			...
			this.fontRendererObj.func_175063_a(var20 = var19.format(var4.field_76330_b) + "%",
					(float) (var8 + var7 - this.fontRendererObj.getStringWidth(var20)), (float) (var9 - var7 / 2 - 16),
					var14);
			...
			for (int var21 = 0; var21 < var3.size(); ++var21) {
				...
				this.fontRendererObj.func_175063_a(var23, (float) (var8 - var7),
						(float) (var9 + var7 / 2 + var21 * 8 + 20), var22.func_76329_a());
				this.fontRendererObj.func_175063_a(var23 = var19.format(var22.field_76332_a) + "%",
						(float) (var8 + var7 - 50 - this.fontRendererObj.getStringWidth(var23)),
						(float) (var9 + var7 / 2 + var21 * 8 + 20), var22.func_76329_a());
				this.fontRendererObj.func_175063_a(var23 = var19.format(var22.field_76330_b) + "%",
						(float) (var8 + var7 - this.fontRendererObj.getStringWidth(var23)),
						(float) (var9 + var7 / 2 + var21 * 8 + 20), var22.func_76329_a());
			}
		}
	}
		...
		if (this.leftClickCounter <= 0 && !this.thePlayer.isUsingItem()) {
			if (leftClick && this.objectMouseOver != null
				...
				if (this.theWorld.getBlockState(var2).getBlock().getMaterial() != Material.air
						&& this.playerController.func_180512_c(var2, this.objectMouseOver.field_178784_b)) {
		...
		if (this.objectMouseOver == null) {
			...
			case 2:
				...
				if (this.theWorld.getBlockState(var3).getBlock().getMaterial() != Material.air) {
					...
					if (this.playerController.func_178890_a(this.thePlayer, this.theWorld, var2, var3,
							this.objectMouseOver.field_178784_b, this.objectMouseOver.hitVec)) {
						var1 = false;
						this.thePlayer.swingItem();
					}
		...
		if (this.currentScreen == null || this.currentScreen.allowUserInput) {
					...
					if (var4 != 0) {
						if (this.thePlayer.func_175149_v()) {
							...
							if (this.ingameGUI.func_175187_g().func_175262_a()) {
								...
								float var5 = MathHelper.clamp_float(
										this.thePlayer.capabilities.getFlySpeed() + (float) var4 * 0.005F, 0.0F, 0.2F);
			...
			while (Keyboard.next()) {
				...
				if (Keyboard.getEventKeyState()) {
					...
					EventKeyboard e = new EventKeyboard(var1);
					EventManager.call(e);

					if (this.currentScreen != null) {
						this.currentScreen.handleKeyboardInput();
					} else {
						Exist.onKeyPressed(var1);
						if (var1 == 1) {
			...
			this.sendClickBlockToController(this.currentScreen == null
					&& this.gameSettings.keyBindAttack.getIsKeyPressed() && this.inGameHasFocus);
		}
	...
	private void middleClickMouse() {
		if (this.objectMouseOver != null) {
			...
			if (this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
				...
				Block var8 = var2 instanceof ItemBlock && !var7.isFlowerPot() ? Block.getBlockFromItem((Item) var2)
						: var7;
